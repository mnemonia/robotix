...
public class Activator implements BundleActivator {
	...
	private ServiceTracker<?, IoSystemService> ioServiceTracker;
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		ioServiceTracker = new ServiceTracker<>(bundleContext, IoSystemService.class.getName(), null);
		ioServiceTracker.open();
		ioSystemService = ioServiceTracker.getService();
		SoundProvider soundProvider = new SoundProvider(timeService, logService);
		doorBellService = new DoorBellServiceImpl(ioSystemService, soundProvider, logService);
