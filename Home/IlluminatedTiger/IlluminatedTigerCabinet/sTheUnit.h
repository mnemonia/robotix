...
#define C_CommandChannel 1
#define C_UpperCenterLightChan 2

/* MESSAGE Enumeration of CHANNEL CommandChannel */

#define C1_ 0
#define C1_UPPER_CENTER_OFF 2
#define C1_UPPER_CENTER_ON 1

/* MESSAGE Enumeration of CHANNEL UpperCenterLightChan */
...
struct tIN_
{
	void (*CommandChannel) (unsigned char);
};
...
struct tOUT_
{
	void (*UpperCenterLightChan) (unsigned char);
};
