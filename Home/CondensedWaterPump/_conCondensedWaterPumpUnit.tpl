...
/*********************************************************************
	...
	CIP Connector Template Module for CIP SHELL sCondensedWaterPumpUnit
	Filename: _conCondensedWaterPumpUnit.tpl
...
unsigned char name_LowerLevelSensorInChan;
unsigned char name_UpperLevelSensorInChan;

	/* Calling Input Functions */

IN_.LowerLevelSensorInChan(name_LowerLevelSensorInChan);
IN_.UpperLevelSensorInChan(name_UpperLevelSensorInChan);
...
/*********************************************************************
	End of CIP Connector Template Module for CIP SHELL sCondensedWaterPumpUnit
*********************************************************************/
