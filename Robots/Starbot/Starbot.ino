...
int threshold_1 = 150;//155; //108;
int threshold_2 = 157;//155; //150;
int threshold_3 = 123;//119; //110;
int threshold_4 = 158;//152;//100;
...
void calibrate(){
  ...
  delay(1500);
  int level = 5;
  threshold_1 = analogRead(ldr1) + level;
  threshold_2 = analogRead(ldr2) + level;
  threshold_3 = analogRead(ldr3) + level;
  threshold_4 = analogRead(ldr4) + level;
