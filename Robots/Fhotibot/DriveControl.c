...
void fICHAN_Radar (unsigned char name_)
{
	...
	case C3_Attention:
		...
		case 2:  /* STATE Forward */
			status_DriveControl.write_access_.STATE = 4;  /* STATE Stop */
			fPULSE_TrackDrive (O3_Stop);
			break;
		case 4:  /* STATE Stop */
			status_DriveControl.write_access_.STATE = 3;  /* STATE Left */
	...
	case C3_Clear:
		...
		case 3:  /* STATE Left */
			...
			break;
		case 4:  /* STATE Stop */
			status_DriveControl.write_access_.STATE = 2;  /* STATE Forward */
