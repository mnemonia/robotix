...
#define C_AmbientAction 12
#define C_AmbientSwitch 11
...
/* MESSAGE Enumeration of CHANNEL AmbientSwitch */

#define C11_ 0
#define C11_TOGGLE 1

/* MESSAGE Enumeration of CHANNEL AmbientAction */
...
struct tIN_
{
	void (*AmbientSwitch) (unsigned char);
...
struct tOUT_
{
	void (*AmbientAction) (unsigned char);
